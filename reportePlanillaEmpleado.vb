...
Public Class reportePlanillaEmpleado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "reportePlanillaEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PlanillasPP1.reportePlanillaEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cedulaEmpleado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedreportePlanillaEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportePlanillaEmpleado = New reportePlanillaEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
